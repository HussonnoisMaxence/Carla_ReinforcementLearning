...
class NoisyLinear(nn.Module):
	...
	def sample_noise(self):
		...
		self.weight_epsilon.copy_(epsilon_out.ger(epsilon_in)) #x.ger(y) = outer product of x and y
...
class NoisyLinearTest(nn.Module):
	def __init__(self, in_features, out_features, std_init=0.4 ):
		super(NoisyLinearTest, self).__init__()
